...
var LongPolling = function (window, undefined) {
  var listener;
  var _listenForChanges = function listenForChanges(url, timestamp) {
    ...
    xhr.onreadystatechange = function () {
      ...
      _listenForChanges(url, this.response.timestamp);
    };
  ...
  var registerListener = function registerListener(callback) {
    listener = callback;
  };
  var options = {
    get: _listenForChanges,
